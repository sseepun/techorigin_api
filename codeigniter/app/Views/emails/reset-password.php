...
<body class="body">
    <table class="full" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td background="{appUrl}public/emails/bg/01.jpg" bgcolor="#494c50" valign="top" style="background-size: cover; background-position: center;">
                <table class="table-inner" align="center" width="600" style="max-width: 600px;" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td align="center" style="line-height: 0px;">
                                        <img style="display:block; line-height:0px; font-size:0px; border:0px; width:45px; height:auto;" src="{appLogo}" alt="logo" />
                                    </td>
                                </tr>
                                <!-- end logo -->
                                <tr>
                    ...
                    <tr>
                        <td align="center" bgcolor="#f3f3f3">
                            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <!-- title -->
                                <tr>
                                    <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:36px; color:#3b3b3b; font-weight: bold;">
                                        ตั้งรหัสผ่านใหม่
                                    </td>
                                </tr>
                                <!-- end title -->
                                ...
                                <tr>
                                    <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:14px; color:#7f8c8d; line-height:29px;">
                                        คุณได้ทำการขอตั้งรหัสผ่านใหม่ในระบบ {appTitle} 
                                        กรุณากดที่ลิงค์ข้างล่างเพื่อดำเนินการต่อ
                                    </td>
                                </tr>
                                <!-- end content -->
                                <tr>
                                ...
                                <tr>
                                    <td align="center">
                                        <table class="textbutton" align="center" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td class="btn-link" bgcolor="#3cb2d0" height="55" align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:16px; color:#FFFFFF;font-weight: bold;padding-left: 25px;padding-right: 25px;border-radius:4px;">
                                                    <a href="{appUrl}reset-password/{salt}">
                                                        ตั้งรหัสผ่านใหม่
                                                    </a>
                                                </td>
                                            </tr>
                    ...
                    <tr>
                        <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#ffffff;">
                            © 2020 {appTitle}. All Rights Reserved.
                        </td>
                    </tr>
                    <!-- end copyright -->
                    <tr>
